 ...
 * 지금까지 서블릿을 생성할 때 doGet, doPost재정의 함 --> service메소드를 재정의(모든 요청 메소드의 요청을 받기 위해서)
 */
public class FrontController extends HttpServlet {
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		// 아래 클래스는 HttpServlet클래스를 상속받지 않는 pojo형태의 클래스 url을 분석
		...
		/** 아래 주석 내용을 객체지향 코드로 변경하기 위해 handlerMapper를 사용하였음 **/
